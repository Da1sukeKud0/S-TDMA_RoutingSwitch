...
if __name__ == '__main__':
    ...
    print("cn/c1: ")
    print((1.0*v_dijkstra(100, 1)/v_dijkstra(100, 1))**2)
    print((1.0*v_dijkstra(100, 2)/v_dijkstra(100, 1))**2)
    print((1.0*v_dijkstra(100, 3)/v_dijkstra(100, 1))**2)
    print((1.0*v_dijkstra(100, 4)/v_dijkstra(100, 1))**2)
    print((1.0*v_dijkstra(100, 5)/v_dijkstra(100, 1))**2)
    print("real: ")
    print(tc_dijkstra(v))
